...
def add_relationship(linkedin_url, website_url):
    ...
    driver.get_screenshot_as_file('img_{}_TestCase2.c.png'.format(now_time))
...
# test case2.a: LinkedIn = NoneURL,Websites =URL
    add_relationship('dsfdsdf', 'http://www.google.com')
    web_close()
