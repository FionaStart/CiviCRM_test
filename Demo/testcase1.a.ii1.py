...
def add_relationship(startdate, enddate, enabled, select_contact_xpath):
    ...
    driver.get_screenshot_as_file('img_{}_TestCase1.a.ii1.png'.format(now_time))  # Screenshot and save named with current time
    js = "var q=document.documentElement.scrollTop=10000"  # scroll page down
    driver.execute_script(js)
    web_load()
    driver.get_screenshot_as_file('img_{}_TestCase1.a.ii1_down.png'.format(now_time))  # Screenshot and save inactive relathonship
...
# test case1.a.ii: Start date < today, Enddate > today, Enabled = NO
    add_relationship('01/05/2022', '05/05/2022', 'NO', '/html/body/div[16]/ul/li[4]')
    web_close()
