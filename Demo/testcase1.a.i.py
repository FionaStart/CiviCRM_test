...
def add_relationship(startdate, enddate, enabled, select_contact_xpath):
    ...
    driver.get_screenshot_as_file('img_{}_TestCase1.a.i.png'.format(now_time))  # Screenshot and save named with current time
    js = "var q=document.documentElement.scrollTop=10000"  # scroll page down
    driver.execute_script(js)
    web_load()
    driver.get_screenshot_as_file('img_{}_TestCase1.a.i_down.png'.format(now_time))  # Screenshot and save inactive relathonship
...
# test case1.a.i:  Start date = Null, Enddate = Null, Enabled = YES
    add_relationship(None, None, 'YES', '//*[@id="select2-drop"]/ul/li[3]')
    web_close()
