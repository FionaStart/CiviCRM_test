...
def add_relationship(startdate, enddate, enabled, select_contact_xpath):
    ...
    driver.get_screenshot_as_file('img_{}_TestCase1.a.ii4.png'.format(now_time))  # Screenshot and save named with current time
    js = "var q=document.documentElement.scrollTop=10000"  # scroll page down
    driver.execute_script(js)
    web_load()
    driver.get_screenshot_as_file('img_{}_TestCase1.a.ii4_down.png'.format(now_time))  # Screenshot and save inactive relathonship
...
# test case1.a.ii: Start date = Null, Enddate = Null, Enabled = NO
    add_relationship(None, None, 'NO', '/html/body/div[16]/ul/li[7]')
    web_close()
