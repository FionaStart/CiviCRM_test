...
def add_relationship(linkedin_url, website_url):
    ...
    driver.get_screenshot_as_file('img_{}_TestCase2.a.png'.format(now_time))
...
# test case2.a: LinkedIn = NoneURL,Websites =NoneURL
    add_relationship('linkedin_url', 'website_url')
    web_close()
