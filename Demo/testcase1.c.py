...
def add_relationship(startdate, enddate, enabled, select_contact_xpath):
    ...
    driver.get_screenshot_as_file('img_{}_TestCase1.c.png'.format(now_time))  # Screenshot and save named with current time
    js = "var q=document.documentElement.scrollTop=10000"  # scroll page down
    driver.execute_script(js)
    web_load()
    driver.get_screenshot_as_file('img_{}_TestCase1.c_down.png'.format(now_time))  # Screenshot and save inactive relathonship
...
# test case1.b: Start date > today, Enddate < today, Enabled = YES
    add_relationship('05/05/2022', '01/05/2022', 'YES', '/html/body/div[16]/ul/li[8]')
    web_close()
